...
namespace main
{
    class Car : IWritableObject, IReadableObject
    {
        ...
        public Car(string autonumber, string brand, int power, int data, string color, string pts)
        {
        ...
        public class Loader : ILoader
        {
            public IReadableObject Load(string[] text)
            {
                ...
                return new Car(autonumber, brand, power, data, color, pts);
            }
        }
    }
}
