...
namespace main
{
    class Mechanic : AutoOwner , IWritableObject, IReadableObject
    {
        protected int qualification;

        public Mechanic() { }
        public Mechanic(string FIO,int qualification,string adres, string phone_number)
        {
            this.FIO = FIO;
        ...
        public class Loader : ILoader
        {
            public IReadableObject Load(string[] text)
            {
                ...
                return new Mechanic(FIO, qualification, adres, phone_number);
            }
        }
    }
}